...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma seguintes contêm as mensagens de erro predefinidas
    | utilizadas pela classe validator. Algumas destas regras têm múltiplas
    | versões, como as regras de tamanho. Sente-te à vontade para ajustar
    | cada uma destas mensagens aqui.
    |
    */
    ...
    'ascii' => 'O campo :attribute deve conter apenas caracteres alfanuméricos e símbolos ASCII (1 byte).',
    ...
    'contains' => 'No campo :attribute está em falta um valor obrigatório.',
    ...
    | especificar uma linha de idioma específica para uma regra de um atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas de idioma seguintes são usadas para substituir o placeholder
    | :attribute por algo mais legível, como "Endereço de Email"
    | em vez de "email". Isto ajuda a tornar a mensagem mais expressiva.
    |
    */
